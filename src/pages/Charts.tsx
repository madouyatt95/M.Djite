...
const investmentData = [
  ...
  { name: 'Juil', value: 1350 },
  { name: 'Août', value: 1800 },
  { name: 'Sep', value: 1500 },
  { name: 'Oct', value: 1700 },
  { name: 'Nov', value: 1400 },
  { name: 'Déc', value: 2000 },
...
const sectorBarData = [
  { name: 'Agriculture', value: 1250, color: '#D4AF37' },
  { name: 'Loisirs', value: 2500, color: '#0EA5FF' },
  { name: 'Immobilier', value: 3800, color: '#8B5CF6' },
  { name: 'Commerce', value: 950, color: '#22C55E' },
  { name: 'Transport', value: 2100, color: '#F59E0B' },
  { name: 'Cinéma', value: 1750, color: '#EF4444' },
];

const dataMap: Record<string, typeof investmentData> = {
  'Investissements': investmentData,
  'Revenus': revenueData,
  'Bénéfices': benefitData,
};

const colorMap: Record<string, string> = {
  'Investissements': '#D4AF37',
  'Revenus': '#0EA5FF',
  'Bénéfices': '#22C55E',
};

const titleMap: Record<string, string> = {
  'Investissements': 'Évolution des Investissements',
  'Revenus': 'Évolution des Revenus',
  'Bénéfices': 'Évolution des Bénéfices',
};
            ...
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={dataMap[activeTab]}>
                ...
                <Line 
                  type="monotone" 
                  dataKey="value" 
                  stroke={colorMap[activeTab]} 
                  strokeWidth={2.5} 
                  dot={{ r: 3, fill: colorMap[activeTab] }}
                  activeDot={{ r: 5, fill: colorMap[activeTab] }}
                />
              </LineChart>
            </ResponsiveContainer>
          </div>
